...
**Please use release version 2.2.0 or 2.3.0 for fully functional MIDI supoprt, 2.5.X is the SpessaSynth testing branch**
...
![Screenshot](https://files.maxdevnet.cc/Pictures/FusionPlayerV2.3.0.png?cache)

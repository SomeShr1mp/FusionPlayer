...
class AudioEngine {
        ...
        try {
            ...
            this.audioContext.addEventListener('statechange', () => {
                ...
                if (this.uiController) {
                    this.uiController.updateAudioContextStatus(this.audioContext.state);
                }
            });
            
            this.updateSystemStatus('Audio context initialized ✓');
            this.updateAudioContextStatus('initialized');
    ...
    async checkAudioWorkletSupport() {
        try {
            ...
            if (!this.audioContext.audioWorklet) {
                ...
                this.updateAudioWorkletStatus('not supported');
                return;
            }
            
            this.updateSystemStatus('Loading AudioWorklet processor...');
            this.updateAudioWorkletStatus('loading');
            ...
            this.updateAudioWorkletStatus('ready');
            ...
            this.updateAudioWorkletStatus('failed');
    ...
    async initializeAudioEngines() {
        ...
        try {
            ...
            this.updateOpenMPTStatus('ready');
        } catch (error) {
            console.warn('OpenMPT initialization failed:', error);
            this.updateOpenMPTStatus('failed');
        }
        ...
        try {
            ...
            this.updateFluidSynthStatus('ready');
        } catch (error) {
            console.warn('Synthesizer initialization failed:', error);
            this.updateFluidSynthStatus('failed');
        }
